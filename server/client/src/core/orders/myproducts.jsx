...
const MyProducts = () => {
  ...
  const deleteProduct = async (productid) => {
    try {
      await fetch(`/deleteproduct/${productid}`, {
        method: "DELETE",
      });
    } catch (err) {
      console.error(err.message);
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Price(in INR) per / </TableCell>
                    <TableCell>Minimum Quantity</TableCell>
                    <TableCell>Delivery Charge (in INR)</TableCell>
                ...
                <TableBody>
                  {products.map((prod) => (
                    <TableRow className="trow" hover={true} key={prod.id}>
                      ...
                      <TableCell>{prod.minquantity} {prod.unit}</TableCell>
